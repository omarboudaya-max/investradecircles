  ...
  return (
    <div className="max-w-3xl mx-auto pb-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
        <h1 className="text-xl sm:text-2xl font-bold">{t.allCircles.title}</h1>
        <Link to="/create-circle" className="self-start sm:self-auto">
          <button className="h-9 px-4 rounded-full bg-primary text-white text-xs sm:text-sm font-semibold hover:bg-primary/90 transition-colors">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-16 px-4">
          ...
          <h3 className="text-base font-semibold mb-1">{t.allCircles.noCircles}</h3>
